...
// console.log(createproduct);
    ...
    createProduct(createproduct).then((response) => {
          ...
          <div className={styles.paddingTop + " max-w-2xl mx-auto mb-8"}>
             ...
             <div >
                  <form className="flex flex-col gap-5 items-center" onSubmit={handleSubmit}>
                    ...
                    <Input required={true} placeholder="Product Name" type="text" name="name" value={createproduct.name} onChange={onProductInputChange}/>
                    <Textarea required={true} placeholder="Description"  name="description" value={createproduct.description} onChange={onProductInputChange}/>
                    <Input required={true} placeholder="Image URL" type="text"  name="avatar" value={createproduct.avatar} onChange={onProductInputChange}/>
                    <CreateCatDrop required={true} catlist={categories}/>
                    <InputNumber required={true} placeholder="Price" type="text"  name="price" value={createproduct.price} onChange={onProductInputChange}/>
